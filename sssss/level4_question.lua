...
local function DisplayQuestion()
    ...
    if (operator == 1) then
        ...
        firstNumber = math.random (1,15)
        secondNumber = math.random (1,15)
...
local function StartTimer()
    ...
    print ("***level4_question: started timer")
...
local function RemoveTextListeners()
    print ("***level4_question: Removed text listeners")
