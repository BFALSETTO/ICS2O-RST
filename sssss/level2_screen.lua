...
local function ReplaceCharacter()
    print ("***level2_screen: Called ReplaceCharacter")
...
local function onCollision( self, event )
    ...
    if ( event.phase == "began" ) then
        ...
        if  (event.target.myName == "star") then
            print ("***level2_screen: onCollision collided with star")
...
local function AddCollisionListeners()
    print ("***level2_screen: Added collision listener on star")
...
local function AddPhysicsBodies()
    ...
    print ("***level2_screen: Added all PhysicsBodies")
...
local function RemovePhysicsBodies()
    print ("***level2_screen: Called RemovePhysicsBodies")
    ...
    --if (theStar ~= nil) and (theStar.isBodyActive == true) then
      --  print ("***level2_screen: Removed physics body on star.")
...
local function YouLose()
    print ("*** level2_screen: Called you YouLose")
...
local function YouWin()
    print ("***level2_question:Called you win")
    won = true
...
function ResumeGameLevel2()
    ...
    if (questionsAnswered > 0) then
        if (theStar ~= nil) and (theStar.isBodyActive == true) then
                physics.removeBody(theStar)
                print ("***level2_screen: ResumeGameLevel2 -- removed physics bodies on star")
                --star.isVisible = false
        end
    end
