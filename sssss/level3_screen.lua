...
local function ReplaceCharacter()
    print ("***level3_screen: Called ReplaceCharacter")
...
local function onCollision( self, event )
    ...
    if ( event.phase == "began" ) then
        ...
        if  (event.target.myName == "star") then
            print ("***level_screen: onCollision collided with star")
        ...
        if  (event.target.myName == "star2") then
            print ("***level3_screen: onCollision collided with star")
...
local function AddCollisionListeners()
    print ("***level3_screen: Added collision listener on star")
...
local function AddPhysicsBodies()
    ...
    print ("***level3_screen: Added all PhysicsBodies")
...
local function RemovePhysicsBodies()
    print ("***level3_screen: Called RemovePhysicsBodies")
...
local function YouLose()
    print ("*** level3_screen: Called you YouLose")
...
local function YouWin()
    print ("***level3_question:Called you win")
...
function ResumeGameLevel3()
    ...
    if (questionsAnswered > 0) then
        if (theStar ~= nil) and (theStar.isBodyActive == true) then
                ...
                print ("***level3_screen: ResumeGameLevel3 -- removed physics bodies on star")
                --star.isVisible = false
        end
    end
...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images/Level2.png", display.contentWidth, display.contentHeight)
